...
export const generateInsight = async (req, res) => {
  ...
  try {
    ...
    const inserted = await pool.query(
      'INSERT INTO ai_insights (user_id, insight_type, period_start, period_end, content_json) VALUES ($1, $2, $3, $4, $5) RETURNING *',
    ...
    res.status(500).json({ message: error.message||'An error occurred while generating the insight' });
  }
};